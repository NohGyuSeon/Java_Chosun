...
abstract class Shape {
	...
	protected abstract Shape move(Point ftype1, Point ftype2);
};
...
class Rect extends Shape {
	...
	public Shape move(int width, int height) {
	...
	public Shape move(Point ftype1, Point ftype2) {

		return new Rect(ftype1, ftype2);
	}
}
			...
			if(menu != 7) {
				...
				case 4:
					...
					if(index == 0) {
						...
						Ftype2.x += width;
						Ftype2.y += height;
						v.set(0, r.move(Ftype1, Ftype2));
					}
					else if(index == 1) {
						Ftype1.x += width;
						Ftype1.y += height;
						v.set(0, new Circle(Fradius, Ftype1));
					}
					else if(index == 2) {
						Ftype1.x += width;
						Ftype1.y += height;
						Ftype2.x += width;
						Ftype2.y += height;
						v.set(0, new Line(Ftype1, Ftype2));
					}
					view();
					break;
				case 5:
					...
					if(hood == 0) {
						...
						Rtype2.x += width;
						Rtype2.y += height;
						v.set(v.size()-1, new Rect(Rtype1, Rtype2));
					}
					else if(hood == 1) {
						Rtype1.x += width;
						Rtype1.y += height;
						v.set(v.size()-1, new Circle(Rradius, Rtype1));
					}
					else if(hood == 2) {
						Rtype1.x += width;
						Rtype1.y += height;
						Rtype2.x += width;
						Rtype2.y += height;
						v.set(v.size()-1, new Line(Rtype1, Rtype2));
					}
					view();
					break;
